                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/proveedores/actualizar.php?Id=<?php echo $resultado['idProveedor'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?Id=<?php echo $resultado['idProveedor'] ?>" class="btn btn-outline-danger">
