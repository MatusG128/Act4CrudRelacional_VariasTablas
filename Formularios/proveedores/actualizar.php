                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url; ?>CRUDC/editarDatos.php" method="post">
                            ...
                            $sql = "SELECT * FROM proveedor WHERE idProveedor =" . $_REQUEST['Id'];
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre del proveedor" value="<?php echo $row['nombre'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="estadoC" class="form-label">Direccion</label>
                                <input type="text" class="form-control" id="direccion" name="direccion" placeholder="Direccion" value="<?php echo $row['direccion'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="nombreC" class="form-label">Nombre Contacto</label>
                                <input type="text" class="form-control" id="nombreC" name="nombreC" placeholder="Nombre del contacto" value="<?php echo $row['nombreContacto'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="telefono" class="form-label">Telefono</label>
                                <input type="text" class="form-control" id="telefono" name="telefono" placeholder="Telefono del proveedor" value="<?php echo $row['telefono'] ?>">
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">email</label>
                                <input type="email" class="form-control" id="email" name="email" placeholder="Email del proveedor" value="<?php echo $row['telefono'] ?>">
                            </div>
